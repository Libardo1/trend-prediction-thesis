...
def process(json_string):
    ...
    clean_obj['user_statuses'] = json_obj['user']['statuses_count']
    clean_obj['source'] = json_obj['source']
    clean_obj['lang'] = '' if json_obj.get('lang') is None else json_obj['lang']
    clean_obj['retweeted'] = json_obj['retweeted']
